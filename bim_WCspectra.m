%% Non-parametric estimation of the Power Spectral Density (PSD) of the process
% with Weighted covariance (WC) estimator
...
function [S,f] = bim_WCspectra(X,m,typecorrest,winname,fs,nfft)
