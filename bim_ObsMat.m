%% compute observation matrix (for entropy computation)

%%% INPUT
% Y: input multiple time series, dimension N*2
...
% j: index of the series (data column) for which current samples are built
